...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aprendizado/images.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 0));
        jLabel2.setText("Current Date and Time ");

        lblHora.setBackground(new java.awt.Color(51, 255, 51));
        lblHora.setFont(new java.awt.Font("Lucida Bright", 1, 12)); // NOI18N
        lblHora.setForeground(new java.awt.Color(255, 0, 0));
        lblHora.setText("Click Here");

        btnHora.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnHora.setForeground(new java.awt.Color(0, 0, 255));
        btnHora.setText(":)");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(72, 72, 72)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnHora, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHoraActionPerformed
        Date aprendizado = new Date();
        lblHora.setText(aprendizado.toString());
